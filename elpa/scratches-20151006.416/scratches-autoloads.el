...

;;;### (autoloads nil "scratches" "scratches.el" (0 0 0 0))
...
See the `scratches-global-mode' command
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "scratches" '("scratches-")))
