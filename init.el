...
;; Indent region 4/-4 spaces, M-Left M-Right. https://stackoverflow.com/a/35183657
(defun indent-region(numSpaces)
  (progn
    (setq regionStart (line-beginning-position)) ; default to start and end of current line
...
(use-package doom-modeline
         ...
         :config
         (set-face-attribute 'mode-line nil :family "Hack Nerd Font Mono" :height 110)
         (set-face-attribute 'mode-line-inactive nil :family "Hack Nerd Font Mono" :height 110))
